...
We consider a road network graph <a href="https://www.codecogs.com/eqnedit.php?latex=G&space;=&space;\langle&space;V,&space;E&space;\rangle" target="_blank"><img src="https://latex.codecogs.com/pgn.latex?G&space;=&space;\langle&space;V,&space;E&space;\rangle" title="G = \langle V, E \rangle" /></a>, where $V$ is a set of $n$ vertices  (road intersections)  and $E$ is a set of $m$ edges (roads). 
